...
type Group6Dto struct {
	...
	Fault1      string  `json:"Fault1"`
	Fault2      string  `json:"Fault2"`
	Fault3      string  `json:"Fault3"`
	Fault4      string  `json:"Fault4"`
	Fault5      string  `json:"Fault5"`
	Fault6      string  `json:"Fault6"`
	Fault7      string  `json:"Fault7"`
	Fault8      string  `json:"Fault8"`
	RelayState  string  `json:"RelayState"`
	SoH         float64 `json:"SoH"`
	EvBmsStatus string  `json:"EvBmsStatus"`
}

func (g *Group6Dto) MapType(b []byte) []interface{} {
	var con []interface{}
